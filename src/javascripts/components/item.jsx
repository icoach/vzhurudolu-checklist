        ...
        return (
            <li className={itemClasses}>
              ...
              <div className='cell checklist-item__toggle'>
                <button className={classNames('checklist-item__button', { 'checklist-item__button--complete': this.props.done })} onClick={this.handleToggle} aria-hidden="false" aria-label={this.state.language.taskComplete} title={this.state.language.taskComplete} type="button">
              ...
              <div className='cell checklist-item__actions'>
                <button onClick={this.handleInfo} aria-hidden="false" aria-label={this.state.language.taskInfo} title={this.state.language.taskInfo} className={descButtonClasses} type="button">
                ...
                <button onClick={this.handleEdit} aria-hidden="false" aria-label={this.state.language.taskEdit} title={this.state.language.taskEdit} className="checklist-item__button" type="button">
                ...
                <button onClick={this.handleRemove} aria-hidden="false" aria-label={this.state.language.taskDelete} title={this.state.language.taskDelete} className="checklist-item__button" type="button">
